...
export const createNationality = async (payload: { country_name: string }) => {
    const response = await api.post('api/employee/nationalities', payload);
    return response.data;
};

export const updateNationality = async (id: number, payload: { country_name: string }) => {
    const response = await api.put(`api/employee/nationalities/${id}`, payload);
    return response.data;
};

export const deleteNationality = async (id: number) => {
    const response = await api.delete(`api/employee/nationalities/${id}`);
    return response.data;
};